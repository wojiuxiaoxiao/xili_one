...
class ModuleObject extends AppObject{
	...
	function Execute(){
		if(in_array($this->Act,array('myReply','doReName','myFavorite','changeFace','doChangePwd','sendPm','replyPm','pmList','sysNotice','myReply','replyMe','verifyTel','doChangeNamePwdGender'))){
			if($this->G['uid']<1){
				$return['status'] = 5100;
