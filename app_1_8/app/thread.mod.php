...
//个人收藏
	...
	function refreshThread(){
		...
		switch ($output['status'])
		{
			case 2000:
				$output['status'] = 0;
				$output['msg']='顶帖成功！今天剩余顶帖次数为'.$output['times'].'次';
            break;
			case 4010:
				$output['msg']='今天的顶帖次数用完，请明天再来';
			break;
			case 4005:
				$output['msg']='非帖子作者';
			break;
...
//        echo json_encode($return);
	...
	public function yewuTest(){
		...
		$action = 'modify';
		$ip =  client_ip();
		$res = postNew($tid,$action,$ip,$uid,$fid);
		var_dump($res);
