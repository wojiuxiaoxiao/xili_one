...
//				$tmp['media']=$this->getMediaList($t['tid']);
//				if($tmp['media']=="")
...
//				else if($this->Config['find_default']['find_3']){
...
//				else if($this->Config['find_default']['find_9']){
...
//				else if($this->Config['find_default']['find_13']){
...
//				}
	...
	function doReplyThread($tid, $uppid, $message, $location, $geolocation,$uid=0,$fromuid){
		...
		file_put_contents('luntanhuifu.txt',var_export($res,true));
