...
//	    $keywords = changeCode($keywords, 'utf-8', 'gbk');
	...
	function getNewsContent(){
        ...
        if(!empty($newsContent_from_cache)){
            ...
            //把从数据库得到的结果存在缓存, 24小时
            if(!empty($newsAry)){
                setVar('newsContent_cache_'.$aid, $newsAry, 1800);
            }
        ...
        if(!empty($newsContent_topiclist_cache)){
            ...
            if(!empty($topicInfoTmp)){
                setVar('newsContent_topiclist_cache_'.$aid, $topicInfoTmp, 1800);
            }
        }
        // -- end of 20180321  缓存缓存topic_list， 2小时
