	...
	function getThreadList(){   
		...
		if($start == 0){
            ...
            if ($thread_ad['status'] == 1){
				...
				$i = 0;
				if ($res_num >= 5){}
				else if($this->Config['thread_default']['topic_5']){
					$arr[] = $this->Config['thread_default']['topic_5'];
					add_show($this->Config['thread_default']['topic_5']['ad_id']);
					array_splice($threadlist, $i+5, 0, $arr);
					$i++;
					unset($arr);
				}
				...
				if ($res_num >= 10){}
				else if($this->Config['thread_default']['topic_10']){
					$arr[] = $this->Config['thread_default']['topic_10'];
					add_show($this->Config['thread_default']['topic_10']['ad_id']);
					array_splice($threadlist, $i+10, 0, $arr);
					$i++;
					unset($arr);
				}
				...
				if ($res_num >= 15){}
				else if($this->Config['thread_default']['topic_15']){
					$arr[] = $this->Config['thread_default']['topic_15'];
					add_show($this->Config['thread_default']['topic_15']['ad_id']);
					array_splice($threadlist, $i+15, 0, $arr);
					$i++;
					unset($arr);
				}
