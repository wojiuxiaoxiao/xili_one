...
//                'pic'=>'',
                'pic'=> (isset($this->getPicList($listTmp['tid'])[0]) && ($this->getPicList($listTmp['tid'])[0]!='nopic')) ? $this->getPicList($listTmp['tid'])[0]:"",
            );
            $message = stripslashes($tmp['message']);
            //获取上级的
