...
/* 2017.05.19 edit by allen qu isPhone都改为1 */
	$config['topic_list'] = array(
		...
		$config['life'] = array(  //2017.05.05 edit by allen qu isPhone改为1
array(
			'forum_name'=>'同城生活',
			'fid'=>92,
			'fid_in'=>'92',
...
$config['work'] = array(  //2017.05.05 edit by allen qu isPhone改为1
	array(
			'forum_name'=>'澳洲校园',
			'fid'=>294,
			'fid_in'=>'294',
...
$config['entertainment'] = array( //2017.05.05 edit by allen qu isPhone改为1
array(
			'forum_name'=>'休闲运动',
			'fid'=>310,
			'fid_in'=>'310',
...
array(
	...
	$city = array(
		...
		array('12','卧龙岗 NSW',array('name'=>'suburb','key'=>'NSW','value'=>array(
			...
			array('Fairy Meadow','Fairy Meadow'),
			array('Gwynneville','Gwynneville'),
			array('Mount Ousley','Mount Ousley'),
			array('North Wollongong','North Wollongong'),
			array('Shellharbour','Shellharbour'),
			array('Wollongong','Wollongong'),
			
		))),
		array('13','中央海岸 NSW',array('name'=>'suburb','key'=>'NSW','value'=>array(
			
            array('Berkeley Vale','Berkeley Vale'),
            array('Killarney Vale','Killarney Vale'),
            array('The Entrance','The Entrance'),
		...
		array('14','吉朗 VIC',array('name'=>'suburb','key'=>'VIC','value'=>array(
			...
			array('East Geelong','East Geelong'),
			array('Geelong city centre','Geelong city centre'),
			array('Geelong West','Geelong West'),
			array('Newtown','Newtown'),
			array('South Geelong','South Geelong'),
			array('Whittington','Whittington'),
			
		))),
		array('15','巴拉瑞特 VIC',array('name'=>'suburb','key'=>'VIC','value'=>array(
			
			array('Alfredton','Alfredton'),
			array('Ballarat Central','Ballarat Central'),
			array('Redan','Redan'),
			
		))),
		array('4','布里斯班 QLD',array('name'=>'suburb','key'=>'QLD','value'=>array(
			
			array('Brisbane City','Brisbane City'),
			array('South Brisbane','South Brisbane'),
			array('St Lucia','St Lucia'),
			array('West End','West End'),
			
		))),
		array('3','黄金海岸 QLD',array('name'=>'suburb','key'=>'QLD','value'=>array(
			
            array('Broadbeach Waters','Broadbeach Waters'),
            array('Bundall','Bundall'),
            array('Clear Island Waters','Clear Island Waters'),
            array('Mermaid Waters','Mermaid Waters'),
            array('Surfers Paradise','Surfers Paradise'),
			
		))),
		array('6','堪培拉 ACT',array('name'=>'suburb','key'=>'ACT','value'=>array(
            
			array('Acton','Acton'),
			array('Ainslie','Ainslie'),
			array('Braddon','Braddon'),
			array('Canberra Central','Canberra Central'),
			array('Dickson','Dickson'),
			array('O\'Connor','O\'Connor'),
			array('Turner','Turner'),
			
		))),
		array('5','阿德莱德 SA',array('name'=>'suburb','key'=>'SA','value'=>array(
			
			array('Adelaide city','Adelaide city'),
			array('Campbelltown','Campbelltown'),
			array('Klemzig','Klemzig'),
			array('Mawson Lakes','Mawson Lakes'),
			array('Marion','Marion'),
			array('Melrose Park','Melrose Park'),
			array('Oaklands Park','Oaklands Park'),
			
		))),
		array('7','珀斯 WA',array('name'=>'suburb','key'=>'WA','value'=>array(
			
			array('Perth City','Perth City'),
			array('Morley','Morley'),
			array('Nedlands','Nedlands'),
			
		))),
		array('8','达尔文 NT',array('name'=>'suburb','key'=>'NT','value'=>array(
			
			array('Darwin City','Darwin City'),
			array('Stuart Park','Stuart Park'),
			array('The Gardens','The Gardens'),
			
		))),
		array('10','霍巴特 TAS',array('name'=>'suburb','key'=>'TAS','value'=>array(
			
			array('Hobart City','Hobart City'),
			array('Moonah','Moonah'),
			array('New Town','New Town'),
			array('Sandy Bay','Sandy Bay'),
