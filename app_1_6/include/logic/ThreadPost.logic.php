...
class ThreadPost
{
    ...
    public function updateThread($tid, $pid, $subject, $message)
    {
    ...
    public function postThread($fid, $subject, $message, $dateline, $typeid=0)
    {
        //判断用户
        if (MEMBER_ID>0) {
