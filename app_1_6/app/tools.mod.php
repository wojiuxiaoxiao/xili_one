...
class ModuleObject extends AppObject
{
    ...
    public function ceshilixi(){
        file_put_contents('test.txt',var_export('tuisongceshi111',true));
        //var_dump('ces');die;
        $curl = curl_init();
        $data = array('cid'=>'f5d74b1cb8df69676f67bda5354da0f6');
        $url = 'localhost/index.php?app=tools&act=pushSingle';
