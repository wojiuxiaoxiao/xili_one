...
//        echo json_encode($return);
	...
	function domesticRegister(){
		...
		$sq = "INSERT INTO yeeyico_new.domestic_adduser values('','{$username}','{$realname}','{$tel}','{$address}','{$email}','{$wechat}','{$pic}','{$status}')";
	...
	function getUserInfo($uid){
		$uid = intval($uid);
		$sql = "select yeeyico_new.pre_common_member.uid,pre_common_member.regdate,pre_common_member.groupid, pre_common_member.status as mstatus, yeeyico_new.pre_common_member.username,yeeyico_new.pre_common_member.credits,yeeyico_new.pre_common_member.groupid,yeeyico_new.pre_phone_verify.status as istel,yeeyico_new.pre_phone_verify.phone as tel
