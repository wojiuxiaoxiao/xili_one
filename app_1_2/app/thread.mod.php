...
//个人收藏
	function myFavorite(){
		$uid=intval(MEMBER_ID);
		if($uid>0){
			$sqlfavorite="select id,title, description from pre_home_favorite where  idtype='fid' and id in(92,646,212,606,732,313,36,318,294,269,93,309,277,310,619,319,234) and uid=".$uid;
