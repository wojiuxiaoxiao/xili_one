...
class ModuleObject extends AppObject{
    ...
    function userThread(){
		...
		if($type == 2){
			...
			if($start>0){
				$threadList = $this->Db->fetch_all_assoc("SELECT author,authorid,replies,'0' as likes,pre_forum_forum.name,pre_forum_thread.fid,pre_forum_thread.tid,subject,dateline,pre_forum_thread_pic.pic FROM `pre_forum_thread` left join pre_forum_forum on pre_forum_forum.fid=pre_forum_thread.fid left join pre_forum_thread_pic on pre_forum_thread.tid=pre_forum_thread_pic.tid  where authorid=".$uid." and pre_forum_thread.displayorder>=0 and   pre_forum_thread.fid in(89,651,161,632,631,630,714,304,643,642,641,142,627,626,625,624,623,622,680,305,677,681,291,653,635,634,633,660,715,716,656,657, 604,325,679) and tid<$start order by tid desc limit $amount");
			}
			else{
				$threadList = $this->Db->fetch_all_assoc("SELECT author,authorid,replies,'0' as likes,pre_forum_forum.name,pre_forum_thread.fid,pre_forum_thread.tid,subject,dateline,pre_forum_thread_pic.pic FROM `pre_forum_thread` left join pre_forum_forum on pre_forum_forum.fid=pre_forum_thread.fid left join pre_forum_thread_pic on pre_forum_thread.tid=pre_forum_thread_pic.tid    where authorid=".$uid." and pre_forum_thread.displayorder>=0 and  pre_forum_thread.fid in(89,651,161,632,631,630,714,304,643,642,641,142,627,626,625,624,623,622,680,305,677,681,291,653,635,634,633,660,715,716,656,657,604,325,679) order by tid desc limit $amount");
			}
		}
		else{
			if($start>0){
				$listTmp = $this->Db->fetch_all_assoc("SELECT author,authorid,replies,'0' as likes,pre_forum_forum.name,pre_forum_thread.fid,pre_forum_thread.tid,subject,dateline,pre_forum_thread_pic.pic FROM `pre_forum_thread` left join pre_forum_forum on pre_forum_forum.fid=pre_forum_thread.fid left join pre_forum_thread_pic on pre_forum_thread.tid=pre_forum_thread_pic.tid   where authorid=".$uid." and pre_forum_thread.displayorder>=0 and   pre_forum_thread.fid not in(89,651,161,632,631,630,714,304,643,642,641,142,627,626,625,624,623,622,680,305,677,681,291,653,635,634,633,660,715,716,656,657,604,325,679) and tid<$start order by tid desc limit $amount");
			}
			else{
				$listTmp = $this->Db->fetch_all_assoc("SELECT author,authorid,replies,'0' as likes,pre_forum_forum.name,pre_forum_thread.fid,pre_forum_thread.tid,subject,dateline,pre_forum_thread_pic.pic FROM `pre_forum_thread` left join pre_forum_forum on pre_forum_forum.fid=pre_forum_thread.fid left join pre_forum_thread_pic on pre_forum_thread.tid=pre_forum_thread_pic.tid  where authorid=".$uid." and pre_forum_thread.displayorder>=0 and  pre_forum_thread.fid not in(89,651,161,632,631,630,714,304,643,642,641,142,627,626,625,624,623,622,680,305,677,681,291,653,635,634,633,660,715,716,656,657,604,325,679) order by tid desc limit $amount");
			}
			if(is_array($listTmp)){
